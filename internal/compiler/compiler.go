// Package compiler contains the compiler implementation
package compiler
...
func (c *Compiler) Compile(node ast.Node) error {
	...
	case *ast.IfExpression:
		...
		// Emit `OpJumpNotTruthy` with a placeholder value
		...
		if node.Else == nil {
			...
			c.changeOperand(jumpNotTruthyPos, afterThenPos)
		} else {
			elseJumpPos := c.emit(code.OpJump, placeholder)
			afterThenPos := len(c.instructions)
			c.changeOperand(jumpNotTruthyPos, afterThenPos)
